...
public class SerializationUtil {
    ...
    static {
        ...
        type_category_map.put("wasdev.DefaultApplication.it.EndpointIT", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.defaultapplication.SnoopServlet", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.defaultapplication.HitCount", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.defaultapplication.Increment", "USER_REMOTE_TYPE");
        type_category_map.put("com.ibm.defaultapplication.IncrementSSB", "USER_REMOTE_TYPE");
        type_category_map.put("com.ibm.defaultapplication.IncrementAction", "USER_REMOTE_TYPE");
    }
